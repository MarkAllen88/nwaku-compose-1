...
function checkFileExistsOnWeb(url) {
...
function checkFileExists(path) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!isValidUrl(path)) return [3 /*break*/, 1];
                    return [2 /*return*/, checkFileExistsOnWeb(path)];
                case 1:
                    if (typeof process === 'undefined' && typeof window !== 'undefined') {
                        throw new Error('not allowed to read local files from browser');
                    }
                    return [4 /*yield*/, import('fs')];
                case 2:
                    fs = _a.sent();
                    return [2 /*return*/, fs.existsSync(path)];
            }
        });
    });
}
...
var resourcesURL = 'https://rln-trusted-setup-ceremony-pse-p0tion-production.s3.eu-central-1.amazonaws.com/circuits';
var rln20URL = "".concat(resourcesURL, "/rln-20");
var withdrawURL = "".concat(resourcesURL, "/rln-withdraw");
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    wasmFileURL = "".concat(url, "/RLN-20.wasm");
                    finalZkeyURL = "".concat(url, "/contributions/rln-20_final.zkey");
                    verificationKeyURL = "".concat(url, "/rln-20_vkey.json");
...
function getDefaultWithdrawParams() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    wasmFileURL = "".concat(withdrawURL, "/RLN-Withdraw.wasm");
                    finalZkeyURL = "".concat(withdrawURL, "/contributions/rln-withdraw_final.zkey");
                    return [4 /*yield*/, Promise.all([
                            downloadBinary(wasmFileURL),
                            downloadBinary(finalZkeyURL),
                        ])];
...
var RLN = /** @class */ (function () {
    ...
    RLN.create = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var rlnIdentifier, registry, cache, identity$1, treeDepth, wasmFilePath, finalZkeyPath, verificationKey, _a, _b, defaultParams;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = typeof args.wasmFilePath === 'string';
                        if (!_a) return [3 /*break*/, 2];
                        return [4 /*yield*/, checkFileExists(args.wasmFilePath)];
                    case 1:
                        _a = !(_c.sent());
                        _c.label = 2;
                    case 2:
                        if (_a) {
                            throw new Error("the file does not exist at the path for `wasmFilePath`: wasmFilePath=".concat(args.wasmFilePath));
                        }
                        _b = typeof args.finalZkeyPath === 'string';
                        if (!_b) return [3 /*break*/, 4];
                        return [4 /*yield*/, checkFileExists(args.finalZkeyPath)];
                    case 3:
                        _b = !(_c.sent());
                        _c.label = 4;
                    case 4:
                        if (_b) {
                            throw new Error("the file does not exist at the path for `finalZkeyPath`: finalZkeyPath=".concat(args.finalZkeyPath));
                        }
                        if (!(args.wasmFilePath === undefined && args.finalZkeyPath === undefined && args.verificationKey === undefined)) return [3 /*break*/, 6];
                        return [4 /*yield*/, getDefaultRLNParams(treeDepth)];
                    case 5:
                        defaultParams = _c.sent();
                    ...
                    case 6:
                        ...
                        _c.label = 7;
                    case 7: return [2 /*return*/, new RLN({
    ...
    RLN.createWithContractRegistry = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var rlnContractWrapper, treeDepth, withdrawWasmFilePath, withdrawFinalZkeyPath, _a, _b, defaultParams, registry, argsWithRegistry;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        treeDepth = args.treeDepth ? args.treeDepth : DEFAULT_MERKLE_TREE_DEPTH;
                        _a = typeof args.withdrawWasmFilePath === 'string';
                        if (!_a) return [3 /*break*/, 2];
                        return [4 /*yield*/, checkFileExists(args.withdrawWasmFilePath)];
                    case 1:
                        _a = !(_c.sent());
                        _c.label = 2;
                    case 2:
                        if (_a) {
                            throw new Error("the file does not exist at the path for `withdrawWasmFilePath`: withdrawWasmFilePath=".concat(args.withdrawWasmFilePath));
                        }
                        _b = typeof args.withdrawFinalZkeyPath === 'string';
                        if (!_b) return [3 /*break*/, 4];
                        return [4 /*yield*/, checkFileExists(args.withdrawFinalZkeyPath)];
                    case 3:
                        _b = !(_c.sent());
                        _c.label = 4;
                    case 4:
                        if (_b) {
                            throw new Error("the file does not exist at the path for `withdrawFinalZkeyPath`: withdrawFinalZkeyPath=".concat(args.withdrawFinalZkeyPath));
                        }
                        if (!(args.withdrawWasmFilePath === undefined && args.withdrawFinalZkeyPath === undefined)) return [3 /*break*/, 6];
